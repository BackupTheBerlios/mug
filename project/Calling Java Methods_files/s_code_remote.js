...
/* SMI Version July19,2004 */
/* Increases hierarchy from 3 to 8
   Adds s_prop2=site_id		*/
...
var s_linkInternalFilters="javascript:,sun.com,java.com,sunsolve,star-auth,sfbay,amused.corp"
...
/* Populate "s_channel" variable (if not already populated). Based on 3 levels of directory; also
   places entire directory path into "s_hier1" (hierarchy) variable. */
if(s_channel==""){
  var s_t1=0
  var s_t2=0
  var s_du=""
